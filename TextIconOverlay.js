...
(function () {
    ...
    var TextIconOverlay =
         ...
         */
        BMapLib.TextIconOverlay = function(position, text, options,markers){
    ...
    TextIconOverlay.prototype._buildCssText = function(style) {
        ...
        csstext.push('cursor:pointer; opacity:0.9; border-radius:50%; color:' + textColor + '; position:absolute; font-size:' +
